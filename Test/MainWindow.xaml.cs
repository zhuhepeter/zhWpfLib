...
using ZhWpfLibrary.UserControls;
...
namespace Test
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            i++;
            ToastUtils.Show(this, $"Title{i}", $"Content{i}",true,new TimeSpan(0,0,3), ToastEnum.Alert) ;
            ToastUtils.Show(this, $"Title{i}", $"Content{i}", true, new TimeSpan(0, 0, 3), ToastEnum.Error);
            ToastUtils.Show(this, $"Title{i}", $"Content{i}", true, new TimeSpan(0, 0, 3), ToastEnum.Infomation);
            ToastUtils.Show(this, $"Title{i}", $"Content{i}", true, new TimeSpan(0, 0, 3), ToastEnum.Success);
        }
        ...
        {
            //NoFrameWindow window = new NoFrameWindow();
            //window.Show();
        }
    }
}
